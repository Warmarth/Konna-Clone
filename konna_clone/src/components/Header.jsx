...
const Header = () => {
  ...
  const features = [
    {
      title: "Payments",
      description: "Enjoy unlimited payment channels",
      icon: (
        <svg
    ...
    },
    {
      ...
      description: "Monitor your business health remotely",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          fill="none"
    ...
    {
      title: "Online Shop",
      description: "Your mobile device can be your shop in a few clicks",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          fill="none"
    ...
    },
    {
      ...
      description: "Keep your stocks organized with ease",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          fill="none"
    ...
    },
    {
      ...
      description: "Manage all your retail activities seamlessly",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          fill="none"
  ...
  const supportedBusinesses = [
    {
      title: "Pharmaceutical Shops",
      description: "Manage your pharmaceutical shops both online and offline.",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          fill="none"
    ...
    {
      title: "Bakeries",
      description: "Facilitate the sale of all baked products.",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          fill="none"
    ...
    {
      title: "Agro-based products",
      description: "Let potential buyers reach you right inside your farm.",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          fill="none"
    ...
    },
    {
      title: "Bars",
      description:
        "Create an online footprint, get wider reach, and track your sales remotely.",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          fill="none"
    ...
    },
    {
      title: "Food Shops",
      description:
        "Allow your food spots to showcase your offerings both online and offline.",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          fill="none"
    ...
    },
    {
      ...
      description: "Connect your electronics shop to customers' devices.",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          fill="none"
    ...
    },
    {
      ...
      description: "Fashion designers, Shoemakers, and Hair stylists.",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          fill="none"
    ...
    {
      title: "Retail Shops",
      description: "Manage retail outlets and connect with your customers.",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          fill="none"
    ...
    {
      title: "Superstores",
      description: "Showcase top brands and fast-selling groceries.",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          fill="none"
    ...
    {
      title: "Kiosks",
      description: "You can showcase your specialties right from your kiosk.",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          fill="none"
    ...
    },
    {
      ...
      description: "Sell finished and imported home or office furniture.",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 24 24"
    ...
    },
    {
      title: "SMEs",
      description:
        "Empowering small businesses to connect with customers and grow.",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 24 24"
  ...
  return (
    <header className="flex items-center justify-between shadow-md top-0 sticky bg-blue-950 px-4 py-2 z-50">
